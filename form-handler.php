<?php
/**
 * TNT Tacky Lights Landing Page Form Handler
 *
 * This script processes form submissions from landing-page.html
...
// Email subject line
define('EMAIL_SUBJECT', 'New Tacky Lights Lead');
...
$emailBody = "New Tacky Lights Lead Received\n";
...
if ($tourInterest === 'YES') {
    $emailBody .= str_repeat("!", 50) . "\n";
    $emailBody .= "⚠️  HOT LEAD: Customer indicated interest in booking!\n";
    $emailBody .= str_repeat("!", 50) . "\n\n";
}

$emailBody .= str_repeat("-", 50) . "\n";
$emailBody .= "Lead Source: Tacky Lights Landing Page\n";
...
<head>
    <style>
        ...
        .value { color: #111827; }
        .hot-lead { background: #fef2f2; border-left: 4px solid #dc2626; padding: 15px; margin: 20px 0; }
...
<body>
    <div class='container'>
        <div class='header'>
            <h2 style='margin: 0;'>New Tacky Lights Lead</h2>
        </div>
        <div class='content'>
...
if ($tourInterest === 'YES') {
    $htmlBody .= "
            <div class='hot-lead'>
                <strong>⚠️ HOT LEAD ALERT</strong><br>
                This customer indicated interest in booking a professional tour!<br>
...
$htmlBody .= "
        ...
        <div class='footer'>
            Lead Source: Tacky Lights Landing Page<br>
...
function log_submission($firstName, $lastName, $email, $tourInterest) {
    $logFile = __DIR__ . '/tacky-lights-leads.csv';
